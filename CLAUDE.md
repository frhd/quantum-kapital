...
- **Core Modules**:
  ...
  - `strategies/`: Strategy detector framework (added Phase 06). Pure types + trait + registry; production detectors registered in Phase 07 (breakout), Phase 08 (episodic pivot), Phase 09 (parabolic short).
