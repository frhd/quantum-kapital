lets start or continue with the next phase of @IMPL.md. mark completed when done, update CLAUDE.MD, then write a short and concise commit message for staged and unstaged changes, and untracked files (ignore loop/), and commit and push. after each phase, wait for further instructions.
