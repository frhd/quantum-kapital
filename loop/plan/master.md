...
| 4. `day_reviews` schema + extended `eod_review.py` + `get_trade_review` / `write_trade_review` MCP tools | [phase-4-trade-review.md](phase-4-trade-review.md) | 2 | in-progress (started 2026-05-05) |
