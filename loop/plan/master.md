...
| 3. `get_watchlist_briefing` MCP fan-out aggregator | [phase-3-watchlist-briefing.md](phase-3-watchlist-briefing.md) | — (parallel-able with 2) | in-progress (started 2026-05-05) |
