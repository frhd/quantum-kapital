...
|---|---|---|---|
| 1. Capture commissions + extend `IbkrExecution` | [phase-1-capture-commissions.md](phase-1-capture-commissions.md) | — | in-progress (started 2026-05-04) |
| 2. MCP `get_executions` tool | [phase-2-mcp-get-executions.md](phase-2-mcp-get-executions.md) | 1 | todo |
