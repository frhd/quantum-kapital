...
| 5. `playbooks` schema + extended `morning_sweep.py` + `get_today_playbook` / `write_playbook` MCP tools | [phase-5-playbook.md](phase-5-playbook.md) | 3 | in-progress (started 2026-05-05) |
