...
pub enum AppEvent {
    // Connection events
    ConnectionStatusChanged { connected: bool, message: String },
    ConnectionError { error: String },
    
    // Account events
    AccountUpdate { account_id: String, data: serde_json::Value },
    AccountsListChanged { accounts: Vec<String> },
    
    // Market data events
    MarketDataUpdate { symbol: String, data: serde_json::Value },
    MarketDataSubscribed { symbol: String },
    MarketDataUnsubscribed { symbol: String },
    
    // Order events
    OrderPlaced { order_id: i32, symbol: String },
    OrderFilled { order_id: i32, filled_qty: f64 },
    OrderCancelled { order_id: i32 },
    OrderError { order_id: Option<i32>, error: String },
    
    // Position events
    PositionUpdate { symbol: String, position: f64 },
    PositionsRefreshed,
